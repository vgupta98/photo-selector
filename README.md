...
| `C` | Compare the current photo with its neighbour (browser), open the grid selection side by side, or review a focused group's frames — 2 photos to Compare, 3–12 to Survey |
