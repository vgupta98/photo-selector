 ...
 * test controls exactly which frames look alike. Returning `null` from [embedder] simulates a
 * transient inference failure (the contract [OnnxEmbeddingModel] now follows). Shared fake — reuse
 * it rather than re-declaring a private one (see the project's testing conventions).
 */
